...
- **Identité d'un coureur : prénom + initiale du nom** (décision du 18/07). Saisis dès la première visite, tous les deux obligatoires. Affichage « Julien B. ». Sans l'initiale, deux adhérents homonymes partagent la même clé et s'écrasent silencieusement : le second efface le programme et le suivi du premier. Dans un club d'une trentaine de personnes aux prénoms français courants, la probabilité d'au moins une paire d'homonymes est estimée entre 20 et 40 %.
